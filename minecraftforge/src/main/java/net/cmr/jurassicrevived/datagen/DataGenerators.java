...
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        generator.addProvider(event.includeClient(), new ForgeBlockStateProvider(packOutput, existingFileHelper));
        generator.addProvider(event.includeClient(), new ForgeItemModelProvider(packOutput, existingFileHelper));
