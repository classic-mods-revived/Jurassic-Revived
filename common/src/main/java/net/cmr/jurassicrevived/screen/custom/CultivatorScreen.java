...
public class CultivatorScreen extends AbstractContainerScreen<CultivatorMenu> {
	private static final ResourceLocation GUI_TEXTURE =
		Constants.rl("textures/gui/fossil_cleaner/fossil_cleaner_gui.png");
	private static final ResourceLocation BUBBLES_TEXTURE =
		Constants.rl("textures/gui/generic/bubbles.png");
	private static final ResourceLocation WHITE_BUBBLES_TEXTURE =
		Constants.rl("textures/gui/generic/white_bubbles.png");
	...
	private static final ResourceLocation SKULL_TEXTURE =
		Constants.rl("textures/gui/generic/skull.png");
