...
public class EmbryoCalcificationMachineScreen extends AbstractContainerScreen<EmbryoCalcificationMachineMenu> {
	private static final ResourceLocation GUI_TEXTURE =
		Constants.rl("textures/gui/embryo_calcification_machine/embryo_calcification_machine_gui.png");
	private static final ResourceLocation SYRINGE_BAR_TEXTURE =
		Constants.rl("textures/gui/generic/syringe_bar.png");
	private static final ResourceLocation WHITE_SYRINGE_BAR_TEXTURE =
		Constants.rl("textures/gui/generic/white_syringe_bar.png");
	...
	private static final ResourceLocation EGG_TEXTURE =
		Constants.rl("textures/gui/generic/egg.png");
