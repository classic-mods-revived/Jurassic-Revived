...
public class DNAExtractorMenu extends AbstractContainerMenu {
	...
	public DNAExtractorMenu(int containerId, Inventory inventory, BlockEntity entity, ContainerData data) {
		...
		this.addSlot(new Slot(blockEntity.itemHandler, 0, 57, 35) {
			@Override
		...
		this.addSlot(new Slot(blockEntity.itemHandler, 1, 80, 7) {
			@Override
			public boolean mayPlace(ItemStack stack) {
		...
		this.addSlot(new Slot(blockEntity.itemHandler, 2, 62, 63) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return false;
			}
		});
		this.addSlot(new Slot(blockEntity.itemHandler, 3, 80, 63) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return false;
			}
		});
		this.addSlot(new Slot(blockEntity.itemHandler, 4, 98, 63) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return false;
			}
