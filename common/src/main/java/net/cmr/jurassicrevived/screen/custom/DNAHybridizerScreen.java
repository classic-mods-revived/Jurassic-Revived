...
public class DNAHybridizerScreen extends AbstractContainerScreen<DNAHybridizerMenu> {
	private static final ResourceLocation GUI_TEXTURE =
		Constants.rl("textures/gui/dna_hybridizer/dna_hybridizer_gui.png");
	private static final ResourceLocation ARROW_TEXTURE =
		Constants.rl("textures/gui/generic/arrow.png");
	private static final ResourceLocation WHITE_ARROW_TEXTURE =
		Constants.rl("textures/gui/generic/white_arrow.png");
