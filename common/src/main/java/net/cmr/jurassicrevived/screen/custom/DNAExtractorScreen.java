...
public class DNAExtractorScreen extends AbstractContainerScreen<DNAExtractorMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            Constants.rl("textures/gui/dna_extractor/dna_extractor_gui.png");
    private static final ResourceLocation DNA_TEXTURE =
            Constants.rl("textures/gui/generic/dna.png");
    ...
    private static final ResourceLocation AMBER_TEXTURE =
            Constants.rl("textures/gui/dna_extractor/amber.png");
