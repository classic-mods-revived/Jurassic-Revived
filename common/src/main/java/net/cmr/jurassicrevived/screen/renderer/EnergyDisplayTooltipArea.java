...
public class EnergyDisplayTooltipArea {
	...
	public EnergyDisplayTooltipArea(int xMin, int yMin, ModEnergyStorage energy)  {
		this(xMin, yMin, energy, 8, 64);
	}

	public EnergyDisplayTooltipArea(int xMin, int yMin, ModEnergyStorage energy, int width, int height)  {
		xPos = xMin;
		yPos = yMin;
		this.width = width;
		this.height = height;
