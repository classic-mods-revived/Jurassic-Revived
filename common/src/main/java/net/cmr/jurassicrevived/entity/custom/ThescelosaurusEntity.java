...
import net.cmr.jurassicrevived.entity.client.ThescelosaurusVariant;
...
public class ThescelosaurusEntity extends DinoEntityBase implements GeoEntity {
	...
	private static final EntityDataAccessor<Integer> VARIANT =
		SynchedEntityData.defineId(ThescelosaurusEntity.class, EntityDataSerializers.INT);
	...
	private static final EntityDataAccessor<Float> DATA_ANIMAL_SCALE =
		SynchedEntityData.defineId(ThescelosaurusEntity.class, EntityDataSerializers.FLOAT);
    ...
    public ThescelosaurusEntity(EntityType<? extends Animal> pEntityType, Level pLevel) {
	...
	public ItemStack getPickResult() {
		return new ItemStack(ModItems.THESCELOSAURUS_SPAWN_EGG.get());
	}
    ...
    public Block getEggBlock() {
        return ModBlocks.INCUBATED_THESCELOSAURUS_EGG.get();
    }
    ...
    public static AttributeSupplier.Builder createAttributes() {
   	...
   	public AgeableMob getBreedOffspring(ServerLevel pLevel, AgeableMob pOtherParent) {
   		AgeableMob child = ModEntities.THESCELOSAURUS.get().create(pLevel);
   		if (child instanceof ThescelosaurusEntity baby) {
   			ThescelosaurusVariant randomVariant = Util.getRandom(ThescelosaurusVariant.values(), this.random);
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        controllers.add(new AnimationController<>(this, "Walk/Run/Idle", 5, state -> {
            if (state.isMoving())
                return state.setAndContinue(ThescelosaurusEntity.this.isSprinting() ? RawAnimation.begin().then("anim.thescelosaurus.run", Animation.LoopType.LOOP) : RawAnimation.begin().then("anim.thescelosaurus.walk", Animation.LoopType.LOOP));

            return state.setAndContinue(RawAnimation.begin().then("anim.thescelosaurus.idle", Animation.LoopType.LOOP));
        }));

        controllers.add(new AnimationController<>(this, "attackController", 5, state -> PlayState.STOP)
                .triggerableAnim("attack", RawAnimation.begin().then("anim.thescelosaurus.attack", Animation.LoopType.PLAY_ONCE)));
    }
    ...
    public void tick() {
		...
		if (!level().isClientSide) {
            if (mouthAnimCooldown > 0) {
                ...
                this.playSound(ModSounds.THESCELOSAURUS_CALL.get(), 1.0F, 1.0F);
                // 30s–60s in ticks
...
public float getLiveDinoScale() {
    ...
    public ThescelosaurusVariant getVariant() {
        return ThescelosaurusVariant.byId(this.getTypeVariant() & 255);
    }

    private void setVariant(ThescelosaurusVariant variant) {
    ...
    public boolean canMate(Animal other) {
        ...
        if (!(other instanceof ThescelosaurusEntity that)) return false;
   	...
   	public SpawnGroupData finalizeSpawn(ServerLevelAccessor pLevel, DifficultyInstance pDifficulty, MobSpawnType pReason, @Nullable SpawnGroupData pSpawnData, @Nullable CompoundTag pDataTag) {
   		ThescelosaurusVariant variant = Util.getRandom(ThescelosaurusVariant.values(), this.random);
   	...
   	public SpawnGroupData finalizeSpawn(ServerLevelAccessor level, DifficultyInstance difficulty, MobSpawnType spawnType, @Nullable SpawnGroupData spawnGroupData) {
   		ThescelosaurusVariant variant = Util.getRandom(ThescelosaurusVariant.values(), this.random);    this.setVariant(variant);    this.setAnimalScale(Mth.nextFloat(this.random, MIN_ANIMAL_SCALE, MAX_ANIMAL_SCALE));    return super.finalizeSpawn(level, difficulty, spawnType, spawnGroupData);}
   	*//*?}*/
    ...
    protected @Nullable SoundEvent getHurtSound(DamageSource damageSource) {
        return ModSounds.THESCELOSAURUS_HURT.get();
    }

    @Override
    protected @Nullable SoundEvent getDeathSound() {
        return ModSounds.THESCELOSAURUS_DEATH.get();
    }

	@Override
	protected @Nullable SoundEvent getAmbientSound() {
		return ModSounds.THESCELOSAURUS_CALL.get();
	}
