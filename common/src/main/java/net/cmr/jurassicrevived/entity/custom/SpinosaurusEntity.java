...
public class SpinosaurusEntity extends DinoEntityBase implements GeoEntity {
	...
	private static final EntityDataAccessor<Float> DATA_ANIMAL_SCALE =
		SynchedEntityData.defineId(SpinosaurusEntity.class, EntityDataSerializers.FLOAT);
    ...
    public Block getEggBlock() {
        return ModBlocks.INCUBATED_SPINOSAURUS_EGG.get();
    }
...
public float getLiveDinoScale() {
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor level, DifficultyInstance difficulty, MobSpawnType spawnType, @Nullable SpawnGroupData spawnGroupData) {
		SpinosaurusVariant variant = Util.getRandom(SpinosaurusVariant.values(), this.random);    this.setVariant(variant);    this.setAnimalScale(Mth.nextFloat(this.random, MIN_ANIMAL_SCALE, MAX_ANIMAL_SCALE));    return super.finalizeSpawn(level, difficulty, spawnType, spawnGroupData);}
	*//*?}*/
