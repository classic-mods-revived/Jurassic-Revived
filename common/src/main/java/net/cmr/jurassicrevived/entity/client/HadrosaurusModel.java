...
public class HadrosaurusModel extends GeoModel<HadrosaurusEntity> {
    ...
    private static final Map<HadrosaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(HadrosaurusVariant.class), map -> {
                map.put(HadrosaurusVariant.MALE, Constants.rl("textures/entity/hadrosaurus.png"));
                map.put(HadrosaurusVariant.FEMALE, Constants.rl("textures/entity/hadrosaurus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(HadrosaurusEntity animatable) {
        return Constants.rl("geo/hadrosaurus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(HadrosaurusEntity animatable) {
        return Constants.rl("animations/hadrosaurus.animation.json");
    }
