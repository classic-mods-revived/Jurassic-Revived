...
public class MoganopterusModel extends GeoModel<MoganopterusEntity> {
    ...
    private static final Map<MoganopterusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(MoganopterusVariant.class), map -> {
                map.put(MoganopterusVariant.MALE, Constants.rl("textures/entity/moganopterus.png"));
                map.put(MoganopterusVariant.FEMALE, Constants.rl("textures/entity/moganopterus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(MoganopterusEntity animatable) {
        return Constants.rl("geo/moganopterus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(MoganopterusEntity animatable) {
        return Constants.rl("animations/moganopterus.animation.json");
    }
