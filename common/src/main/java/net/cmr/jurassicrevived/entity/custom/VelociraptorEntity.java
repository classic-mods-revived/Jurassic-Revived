...
public class VelociraptorEntity extends DinoEntityBase implements GeoEntity {
	...
	private static final EntityDataAccessor<Float> DATA_ANIMAL_SCALE =
		SynchedEntityData.defineId(VelociraptorEntity.class, EntityDataSerializers.FLOAT);
	...
	public ItemStack getPickResult() {
		return new ItemStack(ModItems.VELOCIRAPTOR_SPAWN_EGG.get());
	}
    ...
    public Block getEggBlock() {
        return ModBlocks.INCUBATED_VELOCIRAPTOR_EGG.get();
    }
	...
	*//*?}*/
    ...
    public boolean canMate(Animal other) {
   	...
   	public SpawnGroupData finalizeSpawn(ServerLevelAccessor level, DifficultyInstance difficulty, MobSpawnType spawnType, @Nullable SpawnGroupData spawnGroupData) {
   		VelociraptorVariant variant = Util.getRandom(VelociraptorVariant.values(), this.random);    this.setVariant(variant);    this.setAnimalScale(Mth.nextFloat(this.random, MIN_ANIMAL_SCALE, MAX_ANIMAL_SCALE));    return super.finalizeSpawn(level, difficulty, spawnType, spawnGroupData);}
   	*//*?}*/
