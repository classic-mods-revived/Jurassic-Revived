...
public class DistortusRexEntity extends DinoEntityBase implements GeoEntity {
	...
	public static final int BABY_TO_ADULT_AGE_TICKS = 62400;
	private static final float MIN_ANIMAL_SCALE = 3.2F;
	private static final float MAX_ANIMAL_SCALE = 3.6F;
	...
	private static final EntityDataAccessor<Float> DATA_ANIMAL_SCALE =
		SynchedEntityData.defineId(DistortusRexEntity.class, EntityDataSerializers.FLOAT);
	...
	*//*?}*/
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor level, DifficultyInstance difficulty, MobSpawnType spawnType, @Nullable SpawnGroupData spawnGroupData) {
		DistortusRexVariant variant = Util.getRandom(DistortusRexVariant.values(), this.random);    this.setVariant(variant);    this.setAnimalScale(Mth.nextFloat(this.random, MIN_ANIMAL_SCALE, MAX_ANIMAL_SCALE));    return super.finalizeSpawn(level, difficulty, spawnType, spawnGroupData);}
	*//*?}*/
