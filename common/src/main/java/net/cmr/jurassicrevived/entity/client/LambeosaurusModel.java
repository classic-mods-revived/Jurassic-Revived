...
public class LambeosaurusModel extends GeoModel<LambeosaurusEntity> {
    ...
    private static final Map<LambeosaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(LambeosaurusVariant.class), map -> {
                map.put(LambeosaurusVariant.MALE, Constants.rl("textures/entity/lambeosaurus.png"));
                map.put(LambeosaurusVariant.FEMALE, Constants.rl("textures/entity/lambeosaurus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(LambeosaurusEntity animatable) {
        return Constants.rl("geo/lambeosaurus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(LambeosaurusEntity animatable) {
        return Constants.rl("animations/lambeosaurus.animation.json");
    }
