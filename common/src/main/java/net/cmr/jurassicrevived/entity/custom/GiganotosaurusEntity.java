...
public class GiganotosaurusEntity extends DinoEntityBase implements GeoEntity {
    private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

	public static final int BABY_TO_ADULT_AGE_TICKS = 81600;
	private static final float MIN_ANIMAL_SCALE = 2.0F;
	private static final float MAX_ANIMAL_SCALE = 2.4F;
	...
	private static final EntityDataAccessor<Float> DATA_ANIMAL_SCALE =
		SynchedEntityData.defineId(GiganotosaurusEntity.class, EntityDataSerializers.FLOAT);
    ...
    public Block getEggBlock() {
        return ModBlocks.INCUBATED_GIGANOTOSAURUS_EGG.get();
    }
	...
	*//*?}*/
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor level, DifficultyInstance difficulty, MobSpawnType spawnType, @Nullable SpawnGroupData spawnGroupData) {
		GiganotosaurusVariant variant = Util.getRandom(GiganotosaurusVariant.values(), this.random);    this.setVariant(variant);    this.setAnimalScale(Mth.nextFloat(this.random, MIN_ANIMAL_SCALE, MAX_ANIMAL_SCALE));    return super.finalizeSpawn(level, difficulty, spawnType, spawnGroupData);}
	*//*?}*/
