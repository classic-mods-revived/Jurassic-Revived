...
public class ZhenyuanopterusEntity extends DinoEntityBase implements GeoEntity, FlyingAnimal {
    private final AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

	public static final int BABY_TO_ADULT_AGE_TICKS = 28800;
	private static final float MIN_ANIMAL_SCALE = 0.9F;
	private static final float MAX_ANIMAL_SCALE = 1.3F;
	...
	private static final EntityDataAccessor<Float> DATA_ANIMAL_SCALE =
		SynchedEntityData.defineId(ZhenyuanopterusEntity.class, EntityDataSerializers.FLOAT);
	...
	public ItemStack getPickResult() {
		return new ItemStack(ModItems.ZHENYUANOPTERUS_SPAWN_EGG.get());
	}
    ...
    public Block getEggBlock() {
        return ModBlocks.INCUBATED_ZHENYUANOPTERUS_EGG.get();
    }
	...
	*//*?}*/
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor level, DifficultyInstance difficulty, MobSpawnType spawnType, @Nullable SpawnGroupData spawnGroupData) {
		ZhenyuanopterusVariant variant = Util.getRandom(ZhenyuanopterusVariant.values(), this.random);    this.setVariant(variant);    this.setAnimalScale(Mth.nextFloat(this.random, MIN_ANIMAL_SCALE, MAX_ANIMAL_SCALE));    return super.finalizeSpawn(level, difficulty, spawnType, spawnGroupData);}
	*//*?}*/
