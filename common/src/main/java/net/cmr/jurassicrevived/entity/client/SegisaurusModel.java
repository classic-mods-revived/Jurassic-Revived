...
public class SegisaurusModel extends GeoModel<SegisaurusEntity> {
    ...
    private static final Map<SegisaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(SegisaurusVariant.class), map -> {
                map.put(SegisaurusVariant.MALE, Constants.rl("textures/entity/segisaurus.png"));
                map.put(SegisaurusVariant.FEMALE, Constants.rl("textures/entity/segisaurus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(SegisaurusEntity animatable) {
        return Constants.rl("geo/segisaurus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(SegisaurusEntity animatable) {
        return Constants.rl("animations/segisaurus.animation.json");
    }
