...
public class GuidracoEntity extends DinoEntityBase implements GeoEntity, FlyingAnimal {
	...
	private static final EntityDataAccessor<Float> DATA_ANIMAL_SCALE =
		SynchedEntityData.defineId(GuidracoEntity.class, EntityDataSerializers.FLOAT);
    ...
    public Block getEggBlock() {
        return ModBlocks.INCUBATED_GUIDRACO_EGG.get();
    }
...
public float getLiveDinoScale() {
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor level, DifficultyInstance difficulty, MobSpawnType spawnType, @Nullable SpawnGroupData spawnGroupData) {
		GuidracoVariant variant = Util.getRandom(GuidracoVariant.values(), this.random);    this.setVariant(variant);    this.setAnimalScale(Mth.nextFloat(this.random, MIN_ANIMAL_SCALE, MAX_ANIMAL_SCALE));    return super.finalizeSpawn(level, difficulty, spawnType, spawnGroupData);}
	*//*?}*/
