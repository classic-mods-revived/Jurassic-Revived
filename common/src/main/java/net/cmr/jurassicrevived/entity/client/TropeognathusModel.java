...
public class TropeognathusModel extends GeoModel<TropeognathusEntity> {
    ...
    private static final Map<TropeognathusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(TropeognathusVariant.class), map -> {
                map.put(TropeognathusVariant.MALE, Constants.rl("textures/entity/tropeognathus.png"));
                map.put(TropeognathusVariant.FEMALE, Constants.rl("textures/entity/tropeognathus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(TropeognathusEntity animatable) {
        return Constants.rl("geo/tropeognathus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(TropeognathusEntity animatable) {
        return Constants.rl("animations/tropeognathus.animation.json");
    }
