...
public class TitanosaurusEntity extends DinoEntityBase implements GeoEntity {
    private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

	public static final int BABY_TO_ADULT_AGE_TICKS = 129600;
	private static final float MIN_ANIMAL_SCALE = 2.1F;
	private static final float MAX_ANIMAL_SCALE = 2.5F;
	...
	private static final EntityDataAccessor<Float> DATA_ANIMAL_SCALE =
		SynchedEntityData.defineId(TitanosaurusEntity.class, EntityDataSerializers.FLOAT);
	...
	public ItemStack getPickResult() {
		return new ItemStack(ModItems.TITANOSAURUS_SPAWN_EGG.get());
	}
    ...
    public Block getEggBlock() {
        return ModBlocks.INCUBATED_TITANOSAURUS_EGG.get();
    }
	...
	*//*?}*/
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor level, DifficultyInstance difficulty, MobSpawnType spawnType, @Nullable SpawnGroupData spawnGroupData) {  
		TitanosaurusVariant variant = Util.getRandom(TitanosaurusVariant.values(), this.random);    this.setVariant(variant);    this.setAnimalScale(Mth.nextFloat(this.random, MIN_ANIMAL_SCALE, MAX_ANIMAL_SCALE));    return super.finalizeSpawn(level, difficulty, spawnType, spawnGroupData);}  
	*//*?}*/
