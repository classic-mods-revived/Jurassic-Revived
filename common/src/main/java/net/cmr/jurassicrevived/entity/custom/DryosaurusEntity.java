...
public class DryosaurusEntity extends DinoEntityBase implements GeoEntity {
	...
	private static final float MIN_ANIMAL_SCALE = 0.25F;
	private static final float MAX_ANIMAL_SCALE = 0.65F;
	...
	private static final EntityDataAccessor<Float> DATA_ANIMAL_SCALE =
		SynchedEntityData.defineId(DryosaurusEntity.class, EntityDataSerializers.FLOAT);
	...
	*//*?}*/
    ...
    public boolean canMate(Animal other) {
   	...
   	public SpawnGroupData finalizeSpawn(ServerLevelAccessor level, DifficultyInstance difficulty, MobSpawnType spawnType, @Nullable SpawnGroupData spawnGroupData) {
   		DryosaurusVariant variant = Util.getRandom(DryosaurusVariant.values(), this.random);    this.setVariant(variant);    this.setAnimalScale(Mth.nextFloat(this.random, MIN_ANIMAL_SCALE, MAX_ANIMAL_SCALE));    return super.finalizeSpawn(level, difficulty, spawnType, spawnGroupData);}
   	*//*?}*/
