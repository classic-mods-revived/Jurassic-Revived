...
public class MetriacanthosaurusModel extends GeoModel<MetriacanthosaurusEntity> {
    ...
    private static final Map<MetriacanthosaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(MetriacanthosaurusVariant.class), map -> {
                map.put(MetriacanthosaurusVariant.MALE, Constants.rl("textures/entity/metriacanthosaurus.png"));
                map.put(MetriacanthosaurusVariant.FEMALE, Constants.rl("textures/entity/metriacanthosaurus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(MetriacanthosaurusEntity animatable) {
        return Constants.rl("geo/metriacanthosaurus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(MetriacanthosaurusEntity animatable) {
        return Constants.rl("animations/metriacanthosaurus.animation.json");
    }
