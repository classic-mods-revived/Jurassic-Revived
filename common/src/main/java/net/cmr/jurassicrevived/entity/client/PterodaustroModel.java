...
public class PterodaustroModel extends GeoModel<PterodaustroEntity> {
    ...
    private static final Map<PterodaustroVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(PterodaustroVariant.class), map -> {
                map.put(PterodaustroVariant.MALE, Constants.rl("textures/entity/pterodaustro.png"));
                map.put(PterodaustroVariant.FEMALE, Constants.rl("textures/entity/pterodaustro_female.png"));
            });
    ...
    public ResourceLocation getModelResource(PterodaustroEntity animatable) {
        return Constants.rl("geo/pterodaustro.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(PterodaustroEntity animatable) {
        return Constants.rl("animations/pterodaustro.animation.json");
    }
