...
public class RajasaurusModel extends GeoModel<RajasaurusEntity> {
    ...
    private static final Map<RajasaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(RajasaurusVariant.class), map -> {
                map.put(RajasaurusVariant.MALE, Constants.rl("textures/entity/rajasaurus.png"));
                map.put(RajasaurusVariant.FEMALE, Constants.rl("textures/entity/rajasaurus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(RajasaurusEntity animatable) {
        return Constants.rl("geo/rajasaurus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(RajasaurusEntity animatable) {
        return Constants.rl("animations/rajasaurus.animation.json");
    }
