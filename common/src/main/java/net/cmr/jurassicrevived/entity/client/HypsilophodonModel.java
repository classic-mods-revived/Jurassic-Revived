...
public class HypsilophodonModel extends GeoModel<HypsilophodonEntity> {
    ...
    private static final Map<HypsilophodonVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(HypsilophodonVariant.class), map -> {
                map.put(HypsilophodonVariant.MALE, Constants.rl("textures/entity/hypsilophodon.png"));
                map.put(HypsilophodonVariant.FEMALE, Constants.rl("textures/entity/hypsilophodon_female.png"));
            });
    ...
    public ResourceLocation getModelResource(HypsilophodonEntity animatable) {
        return Constants.rl("geo/hypsilophodon.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(HypsilophodonEntity animatable) {
        return Constants.rl("animations/hypsilophodon.animation.json");
    }
