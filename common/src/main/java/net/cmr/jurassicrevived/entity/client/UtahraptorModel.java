...
public class UtahraptorModel extends GeoModel<UtahraptorEntity> {
    ...
    private static final Map<UtahraptorVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(UtahraptorVariant.class), map -> {
                map.put(UtahraptorVariant.MALE, Constants.rl("textures/entity/utahraptor.png"));
				map.put(UtahraptorVariant.FEMALE, Constants.rl("textures/entity/utahraptor_female.png"));
            });
    ...
    public ResourceLocation getModelResource(UtahraptorEntity animatable) {
        return Constants.rl("geo/utahraptor.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(UtahraptorEntity animatable) {
        return Constants.rl("animations/utahraptor.animation.json");
    }
