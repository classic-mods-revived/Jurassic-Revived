...
public class RajasaurusEntity extends DinoEntityBase implements GeoEntity {
    private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

	public static final int BABY_TO_ADULT_AGE_TICKS = 43200;
	private static final float MIN_ANIMAL_SCALE = 1.0F;
	private static final float MAX_ANIMAL_SCALE = 1.4F;
	...
	private static final EntityDataAccessor<Float> DATA_ANIMAL_SCALE =
		SynchedEntityData.defineId(RajasaurusEntity.class, EntityDataSerializers.FLOAT);
	...
	public ItemStack getPickResult() {
		return new ItemStack(ModItems.RAJASAURUS_SPAWN_EGG.get());
	}
    ...
    public Block getEggBlock() {
        return ModBlocks.INCUBATED_RAJASAURUS_EGG.get();
    }
	...
	*//*?}*/
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor level, DifficultyInstance difficulty, MobSpawnType spawnType, @Nullable SpawnGroupData spawnGroupData) {
		RajasaurusVariant variant = Util.getRandom(RajasaurusVariant.values(), this.random);    this.setVariant(variant);    this.setAnimalScale(Mth.nextFloat(this.random, MIN_ANIMAL_SCALE, MAX_ANIMAL_SCALE));    return super.finalizeSpawn(level, difficulty, spawnType, spawnGroupData);}
	*//*?}*/
