...
public class QuetzalcoatlusModel extends GeoModel<QuetzalcoatlusEntity> {
    ...
    private static final Map<QuetzalcoatlusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(QuetzalcoatlusVariant.class), map -> {
                map.put(QuetzalcoatlusVariant.MALE, Constants.rl("textures/entity/quetzalcoatlus.png"));
                map.put(QuetzalcoatlusVariant.FEMALE, Constants.rl("textures/entity/quetzalcoatlus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(QuetzalcoatlusEntity animatable) {
        return Constants.rl("geo/quetzalcoatlus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(QuetzalcoatlusEntity animatable) {
        return Constants.rl("animations/quetzalcoatlus.animation.json");
    }
