...
public class QuetzalcoatlusEntity extends DinoEntityBase implements GeoEntity, FlyingAnimal {
	...
	private static final EntityDataAccessor<Float> DATA_ANIMAL_SCALE =
		SynchedEntityData.defineId(QuetzalcoatlusEntity.class, EntityDataSerializers.FLOAT);
    ...
    public Block getEggBlock() {
        return ModBlocks.INCUBATED_QUETZALCOATLUS_EGG.get();
    }
	...
	*//*?}*/
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor level, DifficultyInstance difficulty, MobSpawnType spawnType, @Nullable SpawnGroupData spawnGroupData) {
		QuetzalcoatlusVariant variant = Util.getRandom(QuetzalcoatlusVariant.values(), this.random);    this.setVariant(variant);    this.setAnimalScale(Mth.nextFloat(this.random, MIN_ANIMAL_SCALE, MAX_ANIMAL_SCALE));    return super.finalizeSpawn(level, difficulty, spawnType, spawnGroupData);}
	*//*?}*/
