...
public class CeratosaurusEntity extends DinoEntityBase implements GeoEntity {
	...
	private static final EntityDataAccessor<Float> DATA_ANIMAL_SCALE =
		SynchedEntityData.defineId(CeratosaurusEntity.class, EntityDataSerializers.FLOAT);
	...
	*//*?}*/
    ...
    public boolean canMate(Animal other) {
   	...
   	public SpawnGroupData finalizeSpawn(ServerLevelAccessor level, DifficultyInstance difficulty, MobSpawnType spawnType, @Nullable SpawnGroupData spawnGroupData) {
   		CeratosaurusVariant variant = Util.getRandom(CeratosaurusVariant.values(), this.random);    this.setVariant(variant);    this.setAnimalScale(Mth.nextFloat(this.random, MIN_ANIMAL_SCALE, MAX_ANIMAL_SCALE));    return super.finalizeSpawn(level, difficulty, spawnType, spawnGroupData);}
   	*//*?}*/
