...
public class OrnithomimusModel extends GeoModel<OrnithomimusEntity> {
    ...
    private static final Map<OrnithomimusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(OrnithomimusVariant.class), map -> {
                map.put(OrnithomimusVariant.MALE, Constants.rl("textures/entity/ornithomimus.png"));
				map.put(OrnithomimusVariant.FEMALE, Constants.rl("textures/entity/ornithomimus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(OrnithomimusEntity animatable) {
        return Constants.rl("geo/ornithomimus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(OrnithomimusEntity animatable) {
        return Constants.rl("animations/ornithomimus.animation.json");
    }
