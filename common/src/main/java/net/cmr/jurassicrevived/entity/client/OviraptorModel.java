...
public class OviraptorModel extends GeoModel<OviraptorEntity> {
    ...
    private static final Map<OviraptorVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(OviraptorVariant.class), map -> {
                map.put(OviraptorVariant.MALE, Constants.rl("textures/entity/oviraptor.png"));
                map.put(OviraptorVariant.FEMALE, Constants.rl("textures/entity/oviraptor_female.png"));
            });
    ...
    public ResourceLocation getModelResource(OviraptorEntity animatable) {
        return Constants.rl("geo/oviraptor.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(OviraptorEntity animatable) {
        return Constants.rl("animations/oviraptor.animation.json");
    }
