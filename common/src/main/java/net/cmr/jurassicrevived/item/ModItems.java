...
public class ModItems {
	...
	*///?} else {
	...
	public static final RegistrySupplier<Item> TEST_TUBE = ITEMS.register("test_tube", () -> new Item(new Item.Properties()));
	public static final RegistrySupplier<Item> SYRINGE = ITEMS.register("syringe", () -> new FrogSyringeItem(new Item.Properties()));
	public static final RegistrySupplier<Item> MOSQUITO_IN_AMBER = ITEMS.register("mosquito_in_amber", () -> new Item(new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> FROZEN_BONE = ITEMS.register("frozen_bone", () -> new Item(new Item.Properties().rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> CRUSHED_FOSSIL = ITEMS.register("crushed_fossil", () -> new Item(new Item.Properties()));
	public static final RegistrySupplier<Item> FROZEN_LEECH = ITEMS.register("frozen_leech", () -> new Item(new Item.Properties().rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> CABLE = ITEMS.register("cable", () -> new Item(new Item.Properties()));
	public static final RegistrySupplier<Item> SCREEN = ITEMS.register("screen", () -> new Item(new Item.Properties()));
	public static final RegistrySupplier<Item> PROCESSOR = ITEMS.register("processor", () -> new Item(new Item.Properties()));
	public static final RegistrySupplier<Item> TIRE = ITEMS.register("tire", () -> new Item(new Item.Properties()));
	public static final RegistrySupplier<Item> CUTTING_BLADES = ITEMS.register("cutting_blades", () -> new Item(new Item.Properties()));
	...
	// Tissue group
	public static final RegistrySupplier<Item> VELOCIRAPTOR_TISSUE = ITEMS.register("velociraptor_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> TYRANNOSAURUS_REX_TISSUE = ITEMS.register("tyrannosaurus_rex_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> TRICERATOPS_TISSUE = ITEMS.register("triceratops_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> SPINOSAURUS_TISSUE = ITEMS.register("spinosaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> PARASAUROLOPHUS_TISSUE = ITEMS.register("parasaurolophus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> OURANOSAURUS_TISSUE = ITEMS.register("ouranosaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> INDOMINUS_REX_TISSUE = ITEMS.register("indominus_rex_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> GALLIMIMUS_TISSUE = ITEMS.register("gallimimus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> DIPLODOCUS_TISSUE = ITEMS.register("diplodocus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> DILOPHOSAURUS_TISSUE = ITEMS.register("dilophosaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> COMPSOGNATHUS_TISSUE = ITEMS.register("compsognathus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> CERATOSAURUS_TISSUE = ITEMS.register("ceratosaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> BRACHIOSAURUS_TISSUE = ITEMS.register("brachiosaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> ALBERTOSAURUS_TISSUE = ITEMS.register("albertosaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> APATOSAURUS_TISSUE = ITEMS.register("apatosaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> BARYONYX_TISSUE = ITEMS.register("baryonyx_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> CARNOTAURUS_TISSUE = ITEMS.register("carnotaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> CONCAVENATOR_TISSUE = ITEMS.register("concavenator_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> DEINONYCHUS_TISSUE = ITEMS.register("deinonychus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> EDMONTOSAURUS_TISSUE = ITEMS.register("edmontosaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> GIGANOTOSAURUS_TISSUE = ITEMS.register("giganotosaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> GUANLONG_TISSUE = ITEMS.register("guanlong_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> HERRERASAURUS_TISSUE = ITEMS.register("herrerasaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> MAJUNGASAURUS_TISSUE = ITEMS.register("majungasaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> PROCOMPSOGNATHUS_TISSUE = ITEMS.register("procompsognathus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> PROTOCERATOPS_TISSUE = ITEMS.register("protoceratops_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> RUGOPS_TISSUE = ITEMS.register("rugops_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> SHANTUNGOSAURUS_TISSUE = ITEMS.register("shantungosaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> STEGOSAURUS_TISSUE = ITEMS.register("stegosaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> STYRACOSAURUS_TISSUE = ITEMS.register("styracosaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> THERIZINOSAURUS_TISSUE = ITEMS.register("therizinosaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> DISTORTUS_REX_TISSUE = ITEMS.register("distortus_rex_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> ALLOSAURUS_TISSUE = ITEMS.register("allosaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> ALVAREZSAURUS_TISSUE = ITEMS.register("alvarezsaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> ANKYLOSAURUS_TISSUE = ITEMS.register("ankylosaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> ARAMBOURGIANIA_TISSUE = ITEMS.register("arambourgiania_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> CARCHARODONTOSAURUS_TISSUE = ITEMS.register("carcharodontosaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> CEARADACTYLUS_TISSUE = ITEMS.register("cearadactylus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> CHASMOSAURUS_TISSUE = ITEMS.register("chasmosaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> COELOPHYSIS_TISSUE = ITEMS.register("coelophysis_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> COELURUS_TISSUE = ITEMS.register("coelurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> CORYTHOSAURUS_TISSUE = ITEMS.register("corythosaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> DIMORPHODON_TISSUE = ITEMS.register("dimorphodon_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> DRYOSAURUS_TISSUE = ITEMS.register("dryosaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> GEOSTERNBERGIA_TISSUE = ITEMS.register("geosternbergia_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> GUIDRACO_TISSUE = ITEMS.register("guidraco_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> HADROSAURUS_TISSUE = ITEMS.register("hadrosaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> HYPSILOPHODON_TISSUE = ITEMS.register("hypsilophodon_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> INDORAPTOR_TISSUE = ITEMS.register("indoraptor_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> INOSTRANCEVIA_TISSUE = ITEMS.register("inostrancevia_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> LAMBEOSAURUS_TISSUE = ITEMS.register("lambeosaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> LUDODACTYLUS_TISSUE = ITEMS.register("ludodactylus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> MAMENCHISAURUS_TISSUE = ITEMS.register("mamenchisaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> METRIACANTHOSAURUS_TISSUE = ITEMS.register("metriacanthosaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> MOGANOPTERUS_TISSUE = ITEMS.register("moganopterus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> NYCTOSAURUS_TISSUE = ITEMS.register("nyctosaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> ORNITHOLESTES_TISSUE = ITEMS.register("ornitholestes_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> ORNITHOMIMUS_TISSUE = ITEMS.register("ornithomimus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> OVIRAPTOR_TISSUE = ITEMS.register("oviraptor_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> PACHYCEPHALOSAURUS_TISSUE = ITEMS.register("pachycephalosaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> PROCERATOSAURUS_TISSUE = ITEMS.register("proceratosaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> PTERANODON_TISSUE = ITEMS.register("pteranodon_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> PTERODAUSTRO_TISSUE = ITEMS.register("pterodaustro_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> QUETZALCOATLUS_TISSUE = ITEMS.register("quetzalcoatlus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> RAJASAURUS_TISSUE = ITEMS.register("rajasaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> SEGISAURUS_TISSUE = ITEMS.register("segisaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> TAPEJARA_TISSUE = ITEMS.register("tapejara_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> TITANOSAURUS_TISSUE = ITEMS.register("titanosaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> TROODON_TISSUE = ITEMS.register("troodon_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> TROPEOGNATHUS_TISSUE = ITEMS.register("tropeognathus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> TUPUXUARA_TISSUE = ITEMS.register("tupuxuara_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> UTAHRAPTOR_TISSUE = ITEMS.register("utahraptor_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> ZHENYUANOPTERUS_TISSUE = ITEMS.register("zhenyuanopterus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> ACHILLOBATOR_TISSUE = ITEMS.register("achillobator_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> SUCHOMIMUS_TISSUE = ITEMS.register("suchomimus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> CHILESAURUS_TISSUE = ITEMS.register("chilesaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> THESCELOSAURUS_TISSUE = ITEMS.register("thescelosaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> MUSSASAURUS_TISSUE = ITEMS.register("mussasaurus_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> COELACANTH_TISSUE = ITEMS.register("coelacanth_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> MAWSONIA_TISSUE = ITEMS.register("mawsonia_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));
	public static final RegistrySupplier<Item> ALLIGATOR_GAR_TISSUE = ITEMS.register("alligator_gar_tissue", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.EPIC)));


	// DNA group
	public static final RegistrySupplier<Item> VELOCIRAPTOR_DNA = ITEMS.register("velociraptor_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> TYRANNOSAURUS_REX_DNA = ITEMS.register("tyrannosaurus_rex_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> TRICERATOPS_DNA = ITEMS.register("triceratops_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> SPINOSAURUS_DNA = ITEMS.register("spinosaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> PARASAUROLOPHUS_DNA = ITEMS.register("parasaurolophus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> OURANOSAURUS_DNA = ITEMS.register("ouranosaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> INDOMINUS_REX_DNA = ITEMS.register("indominus_rex_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> GALLIMIMUS_DNA = ITEMS.register("gallimimus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> DIPLODOCUS_DNA = ITEMS.register("diplodocus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> DILOPHOSAURUS_DNA = ITEMS.register("dilophosaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> COMPSOGNATHUS_DNA = ITEMS.register("compsognathus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> CERATOSAURUS_DNA = ITEMS.register("ceratosaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> BRACHIOSAURUS_DNA = ITEMS.register("brachiosaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> ALBERTOSAURUS_DNA = ITEMS.register("albertosaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> APATOSAURUS_DNA = ITEMS.register("apatosaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> BARYONYX_DNA = ITEMS.register("baryonyx_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> CARNOTAURUS_DNA = ITEMS.register("carnotaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> CONCAVENATOR_DNA = ITEMS.register("concavenator_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> DEINONYCHUS_DNA = ITEMS.register("deinonychus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> EDMONTOSAURUS_DNA = ITEMS.register("edmontosaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> GIGANOTOSAURUS_DNA = ITEMS.register("giganotosaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> GUANLONG_DNA = ITEMS.register("guanlong_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> HERRERASAURUS_DNA = ITEMS.register("herrerasaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> MAJUNGASAURUS_DNA = ITEMS.register("majungasaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> PROCOMPSOGNATHUS_DNA = ITEMS.register("procompsognathus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> PROTOCERATOPS_DNA = ITEMS.register("protoceratops_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> RUGOPS_DNA = ITEMS.register("rugops_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> SHANTUNGOSAURUS_DNA = ITEMS.register("shantungosaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> STEGOSAURUS_DNA = ITEMS.register("stegosaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> STYRACOSAURUS_DNA = ITEMS.register("styracosaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> THERIZINOSAURUS_DNA = ITEMS.register("therizinosaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> DISTORTUS_REX_DNA = ITEMS.register("distortus_rex_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> ALLOSAURUS_DNA = ITEMS.register("allosaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> ALVAREZSAURUS_DNA = ITEMS.register("alvarezsaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> ANKYLOSAURUS_DNA = ITEMS.register("ankylosaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> ARAMBOURGIANIA_DNA = ITEMS.register("arambourgiania_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> CARCHARODONTOSAURUS_DNA = ITEMS.register("carcharodontosaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> CEARADACTYLUS_DNA = ITEMS.register("cearadactylus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> CHASMOSAURUS_DNA = ITEMS.register("chasmosaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> COELOPHYSIS_DNA = ITEMS.register("coelophysis_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> COELURUS_DNA = ITEMS.register("coelurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> CORYTHOSAURUS_DNA = ITEMS.register("corythosaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> DIMORPHODON_DNA = ITEMS.register("dimorphodon_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> DRYOSAURUS_DNA = ITEMS.register("dryosaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> GEOSTERNBERGIA_DNA = ITEMS.register("geosternbergia_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> GUIDRACO_DNA = ITEMS.register("guidraco_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> HADROSAURUS_DNA = ITEMS.register("hadrosaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> HYPSILOPHODON_DNA = ITEMS.register("hypsilophodon_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> INDORAPTOR_DNA = ITEMS.register("indoraptor_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> INOSTRANCEVIA_DNA = ITEMS.register("inostrancevia_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> LAMBEOSAURUS_DNA = ITEMS.register("lambeosaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> LUDODACTYLUS_DNA = ITEMS.register("ludodactylus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> MAMENCHISAURUS_DNA = ITEMS.register("mamenchisaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> METRIACANTHOSAURUS_DNA = ITEMS.register("metriacanthosaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> MOGANOPTERUS_DNA = ITEMS.register("moganopterus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> NYCTOSAURUS_DNA = ITEMS.register("nyctosaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> ORNITHOLESTES_DNA = ITEMS.register("ornitholestes_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> ORNITHOMIMUS_DNA = ITEMS.register("ornithomimus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> OVIRAPTOR_DNA = ITEMS.register("oviraptor_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> PACHYCEPHALOSAURUS_DNA = ITEMS.register("pachycephalosaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> PROCERATOSAURUS_DNA = ITEMS.register("proceratosaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> PTERANODON_DNA = ITEMS.register("pteranodon_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> PTERODAUSTRO_DNA = ITEMS.register("pterodaustro_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> QUETZALCOATLUS_DNA = ITEMS.register("quetzalcoatlus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> RAJASAURUS_DNA = ITEMS.register("rajasaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> SEGISAURUS_DNA = ITEMS.register("segisaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> TAPEJARA_DNA = ITEMS.register("tapejara_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> TITANOSAURUS_DNA = ITEMS.register("titanosaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> TROODON_DNA = ITEMS.register("troodon_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> TROPEOGNATHUS_DNA = ITEMS.register("tropeognathus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> TUPUXUARA_DNA = ITEMS.register("tupuxuara_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> UTAHRAPTOR_DNA = ITEMS.register("utahraptor_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> ZHENYUANOPTERUS_DNA = ITEMS.register("zhenyuanopterus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> ACHILLOBATOR_DNA = ITEMS.register("achillobator_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> SUCHOMIMUS_DNA = ITEMS.register("suchomimus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> CHILESAURUS_DNA = ITEMS.register("chilesaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> THESCELOSAURUS_DNA = ITEMS.register("thescelosaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> MUSSASAURUS_DNA = ITEMS.register("mussasaurus_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> COELACANTH_DNA = ITEMS.register("coelacanth_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> MAWSONIA_DNA = ITEMS.register("mawsonia_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistrySupplier<Item> ALLIGATOR_GAR_DNA = ITEMS.register("alligator_gar_dna", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));


	// Syringe group
	public static final RegistrySupplier<Item> VELOCIRAPTOR_SYRINGE = ITEMS.register("velociraptor_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> TYRANNOSAURUS_REX_SYRINGE = ITEMS.register("tyrannosaurus_rex_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> TRICERATOPS_SYRINGE = ITEMS.register("triceratops_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> SPINOSAURUS_SYRINGE = ITEMS.register("spinosaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> PARASAUROLOPHUS_SYRINGE = ITEMS.register("parasaurolophus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> OURANOSAURUS_SYRINGE = ITEMS.register("ouranosaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> INDOMINUS_REX_SYRINGE = ITEMS.register("indominus_rex_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> GALLIMIMUS_SYRINGE = ITEMS.register("gallimimus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> DIPLODOCUS_SYRINGE = ITEMS.register("diplodocus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> DILOPHOSAURUS_SYRINGE = ITEMS.register("dilophosaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> COMPSOGNATHUS_SYRINGE = ITEMS.register("compsognathus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> CERATOSAURUS_SYRINGE = ITEMS.register("ceratosaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> BRACHIOSAURUS_SYRINGE = ITEMS.register("brachiosaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> ALBERTOSAURUS_SYRINGE = ITEMS.register("albertosaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> APATOSAURUS_SYRINGE = ITEMS.register("apatosaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> BARYONYX_SYRINGE = ITEMS.register("baryonyx_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> CARNOTAURUS_SYRINGE = ITEMS.register("carnotaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> CONCAVENATOR_SYRINGE = ITEMS.register("concavenator_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> DEINONYCHUS_SYRINGE = ITEMS.register("deinonychus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> EDMONTOSAURUS_SYRINGE = ITEMS.register("edmontosaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> GIGANOTOSAURUS_SYRINGE = ITEMS.register("giganotosaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> GUANLONG_SYRINGE = ITEMS.register("guanlong_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> HERRERASAURUS_SYRINGE = ITEMS.register("herrerasaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> MAJUNGASAURUS_SYRINGE = ITEMS.register("majungasaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> PROCOMPSOGNATHUS_SYRINGE = ITEMS.register("procompsognathus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> PROTOCERATOPS_SYRINGE = ITEMS.register("protoceratops_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> RUGOPS_SYRINGE = ITEMS.register("rugops_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> SHANTUNGOSAURUS_SYRINGE = ITEMS.register("shantungosaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> STEGOSAURUS_SYRINGE = ITEMS.register("stegosaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> STYRACOSAURUS_SYRINGE = ITEMS.register("styracosaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> THERIZINOSAURUS_SYRINGE = ITEMS.register("therizinosaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> DISTORTUS_REX_SYRINGE = ITEMS.register("distortus_rex_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> ALLOSAURUS_SYRINGE = ITEMS.register("allosaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> ALVAREZSAURUS_SYRINGE = ITEMS.register("alvarezsaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> ANKYLOSAURUS_SYRINGE = ITEMS.register("ankylosaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> ARAMBOURGIANIA_SYRINGE = ITEMS.register("arambourgiania_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> CARCHARODONTOSAURUS_SYRINGE = ITEMS.register("carcharodontosaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> CEARADACTYLUS_SYRINGE = ITEMS.register("cearadactylus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> CHASMOSAURUS_SYRINGE = ITEMS.register("chasmosaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> COELOPHYSIS_SYRINGE = ITEMS.register("coelophysis_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> COELURUS_SYRINGE = ITEMS.register("coelurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> CORYTHOSAURUS_SYRINGE = ITEMS.register("corythosaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> DIMORPHODON_SYRINGE = ITEMS.register("dimorphodon_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> DRYOSAURUS_SYRINGE = ITEMS.register("dryosaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> GEOSTERNBERGIA_SYRINGE = ITEMS.register("geosternbergia_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> GUIDRACO_SYRINGE = ITEMS.register("guidraco_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> HADROSAURUS_SYRINGE = ITEMS.register("hadrosaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> HYPSILOPHODON_SYRINGE = ITEMS.register("hypsilophodon_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> INDORAPTOR_SYRINGE = ITEMS.register("indoraptor_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> INOSTRANCEVIA_SYRINGE = ITEMS.register("inostrancevia_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> LAMBEOSAURUS_SYRINGE = ITEMS.register("lambeosaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> LUDODACTYLUS_SYRINGE = ITEMS.register("ludodactylus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> MAMENCHISAURUS_SYRINGE = ITEMS.register("mamenchisaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> METRIACANTHOSAURUS_SYRINGE = ITEMS.register("metriacanthosaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> MOGANOPTERUS_SYRINGE = ITEMS.register("moganopterus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> NYCTOSAURUS_SYRINGE = ITEMS.register("nyctosaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> ORNITHOLESTES_SYRINGE = ITEMS.register("ornitholestes_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> ORNITHOMIMUS_SYRINGE = ITEMS.register("ornithomimus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> OVIRAPTOR_SYRINGE = ITEMS.register("oviraptor_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> PACHYCEPHALOSAURUS_SYRINGE = ITEMS.register("pachycephalosaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> PROCERATOSAURUS_SYRINGE = ITEMS.register("proceratosaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> PTERANODON_SYRINGE = ITEMS.register("pteranodon_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> PTERODAUSTRO_SYRINGE = ITEMS.register("pterodaustro_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> QUETZALCOATLUS_SYRINGE = ITEMS.register("quetzalcoatlus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> RAJASAURUS_SYRINGE = ITEMS.register("rajasaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> SEGISAURUS_SYRINGE = ITEMS.register("segisaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> TAPEJARA_SYRINGE = ITEMS.register("tapejara_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> TITANOSAURUS_SYRINGE = ITEMS.register("titanosaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> TROODON_SYRINGE = ITEMS.register("troodon_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> TROPEOGNATHUS_SYRINGE = ITEMS.register("tropeognathus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> TUPUXUARA_SYRINGE = ITEMS.register("tupuxuara_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> UTAHRAPTOR_SYRINGE = ITEMS.register("utahraptor_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> ZHENYUANOPTERUS_SYRINGE = ITEMS.register("zhenyuanopterus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> ACHILLOBATOR_SYRINGE = ITEMS.register("achillobator_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> SUCHOMIMUS_SYRINGE = ITEMS.register("suchomimus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> CHILESAURUS_SYRINGE = ITEMS.register("chilesaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> THESCELOSAURUS_SYRINGE = ITEMS.register("thescelosaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> MUSSASAURUS_SYRINGE = ITEMS.register("mussasaurus_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> COELACANTH_SYRINGE = ITEMS.register("coelacanth_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> MAWSONIA_SYRINGE = ITEMS.register("mawsonia_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> ALLIGATOR_GAR_SYRINGE = ITEMS.register("alligator_gar_syringe", () -> new Item(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
