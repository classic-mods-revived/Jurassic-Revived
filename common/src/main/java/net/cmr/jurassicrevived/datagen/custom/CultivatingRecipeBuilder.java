...
public class CultivatingRecipeBuilder {
    ...
    *///?} else {
    ...
    public CultivatingRecipeBuilder(ItemLike ingredient, ItemLike placeholderResult, int count) {
    ...
    public static CultivatingRecipeBuilder randomFossil(ItemLike consumableInput, ItemLike placeholderResult, int count) {
        return new CultivatingRecipeBuilder(consumableInput, placeholderResult, count);
    }

    public CultivatingRecipeBuilder addFossilWeight(ItemLike fossilItem, int weight) {
    ...
    /*public void save(RecipeOutput output) {
        ...
        ResourceLocation id = ResourceLocation.fromNamespaceAndPath(
                ...
                resultKey.getPath() + "_from_cultivating"
        );
        save(output, id);
    }
    ...
    public void save(RecipeOutput output, ResourceLocation recipeId) {
        ...
        CultivatorRecipe recipe = new CultivatorRecipe(inputs, result, Map.copyOf(this.weights));
    ...
    *///?} else {
    ...
    //? if >1.20.1 {
    /*public CultivatingRecipeBuilder unlockedBy(String name, Criterion<?> criterion) {
    *///?} else {
    public CultivatingRecipeBuilder unlockedBy(String name, InventoryChangeTrigger.TriggerInstance criterion) {
    //?}
